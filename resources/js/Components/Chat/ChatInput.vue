...
<template>
    <div class="sticky bottom-4 flex h-14 w-full items-center px-4">
        <div class="relative w-full">
            <TextInput
                placeholder="Type something..."
                class="relative h-14 w-full rounded-3xl border-none px-5 pr-10 text-gray-700 shadow-[5px_4px_20px_rgba(0,_0,_0,_0.13)] focus:!border-none focus:!ring-0"
            />
        </div>
